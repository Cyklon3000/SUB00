...
public class Upgrade : MonoBehaviour
{
    ...
    {
        selectedCost = int.Parse(currentUpgrades.transform.GetChild(upgrade + 1).Find("Pricing").GetComponent<TextMeshProUGUI>().text);
        if (inventory.hasItems("Currency", selectedCost))
        {
